...
METRO_MONDAY = slots(
    ("00:00", "My Italy with Margarita"),
    ("00:30", "Casa Daza: S5"),
    ("01:00", "Jamie and Jimmy's Food Fight Club"),
    ("02:00", "Asian Baking Adventures"),
    ("02:30", "The Crawl"),
    ("03:00", "Beached"),
    ("04:00", "Pia's Postcards"),
    ("05:00", "Jamie and Jimmy's Food Fight Club"),
    ("06:00", "My Italy with Margarita"),
    ("06:30", "Casa Daza: S2"),
    ("07:00", "Metabeats"),
    ("08:00", "Kapamilya Daily Mass"),
    ("08:30", "Potluck"),
    ("08:45", "Gourmet Takeaway"),
    ("09:00", "The Crawl"),
    ("09:30", "Jamie and Jimmy's Food Fight Club"),
    ("10:30", "EIC on the Move: S2"),
    ("11:00", "Executive Class"),
    ("12:00", "Pia's Postcards"),
    ("13:00", "Coolest Places to Stay"),
    ("14:00", "Potluck"),
    ("14:15", "Gourmet Takeaway"),
    ("14:30", "Jamie and Jimmy's Food Fight Club"),
    ("15:30", "The Crawl"),
    ("16:00", "It's a Small World"),
    ("16:30", "Coolest Places to Stay"),
    ("17:30", "EIC on the Move: S2"),
    ("18:00", "Metabeats"),
    ("19:00", "Casa Daza: S2"),
    ("19:30", "Beached: S2"),
    ("20:30", "My Italy with Margarita"),
    ("21:00", "It's a Small World"),
    ("21:30", "Asian Baking Adventures"),
    ("22:00", "Extraordinary Places to Eat"),
    ("23:00", "Executive Class"),
)
METRO_TUESDAY = slots(
    ("00:00", "Million Dollar Listing Miami"),
    ("01:00", "Executive Class"),
    ("02:00", "Coolest Places to Stay"),
    ("03:00", "Million Dollar Listing New York"),
    ("04:00", "Extraordinary Places to Eat"),
    ("05:00", "Beached: S3"),
    ("06:00", "My Italy with Margarita"),
    ("06:30", "Asian Baking Adventures"),
    ("07:00", "Million Dollar Listing Miami"),
    ("08:00", "Kapamilya Daily Mass"),
    ("08:30", "Casa Daza: S5"),
    ("09:00", "Jamie and Jimmy's Food Fight Club"),
    ("10:00", "Metabeats"),
    ("11:00", "Jamie's Quick and Easy Food"),
    ("12:00", "Extraordinary Places to Eat"),
    ("13:00", "It's a Small World"),
    ("13:30", "My Italy with Margarita"),
    ("14:00", "Extraordinary Places to Eat"),
    ("15:00", "Metabeats"),
    ("16:00", "EIC on the Move: S2"),
    ("16:30", "Potluck"),
    ("16:45", "Gourmet Takeaway"),
    ("17:00", "Jamie and Jimmy's Food Fight Club"),
    ("18:00", "Extraordinary Places to Eat"),
    ("19:00", "Pia's Postcards"),
    ("20:00", "Potluck"),
    ("20:15", "Gourmet Takeaway"),
    ("20:30", "Casa Daza: S5"),
    ("21:00", "EIC on the Move: S2"),
    ("21:30", "The Crawl"),
    ("22:00", "Jamie's Quick and Easy Food"),
    ("23:00", "Tour vs. Tour: S3"),
)
METRO_WEDNESDAY = slots(
    ("00:00", "The Crawl"),
    ("00:30", "My Italy with Margarita"),
    ("01:00", "Let's Stan"),
    ("02:00", "Pia's Postcards"),
    ("03:00", "Tour vs. Tour: S3"),
    ("04:00", "Executive Class"),
    ("05:00", "Jamie and Jimmy's Food Fight Club"),
    ("06:00", "Metabeats"),
    ("07:00", "The Crawl"),
    ("07:30", "Potluck"),
    ("07:45", "Gourmet Takeaway"),
    ("08:00", "Kapamilya Daily Mass"),
    ("08:30", "Executive Class"),
    ("09:30", "EIC on the Move: S2"),
    ("10:00", "Pia's Postcards"),
    ("11:00", "Casa Daza: S2"),
    ("11:30", "It's a Small World"),
    ("12:00", "Potluck"),
    ("12:15", "Gourmet Takeaway"),
    ("12:30", "The Crawl"),
    ("13:00", "Jamie and Jimmy's Food Fight Club"),
    ("14:00", "Pia's Postcards"),
    ("15:00", "G Diaries Share the Love"),
    ("16:30", "Metabeats"),
    ("17:30", "EIC on the Move: S2"),
    ("18:00", "Tour vs. Tour: S3"),
    ("19:00", "It's a Small World"),
    ("19:30", "Casa Daza: S2"),
    ("20:00", "Let's Stan"),
    ("21:00", "My Italy with Margarita"),
    ("21:30", "Asian Baking Adventures"),
    ("22:00", "Executive Class"),
    ("23:00", "Potluck"),
    ("23:15", "Gourmet Takeaway"),
    ("23:30", "EIC on the Move: S2"),
)
METRO_THURSDAY = slots(
    ("00:00", "Pia's Postcards"),
    ("01:00", "Asian Baking Adventures"),
    ("01:30", "The Crawl"),
    ("02:00", "Let's Stan"),
    ("03:00", "Kuwentong Barber"),
    ("04:00", "Jamie Cooks Italy"),
    ("05:00", "Pia's Postcards"),
    ("06:00", "EIC on the Move"),
    ("06:30", "It's a Small World"),
    ("07:00", "Tour vs. Tour: S3"),
    ("08:00", "Kapamilya Daily Mass"),
    ("08:30", "Potluck"),
    ("08:45", "Gourmet Takeaway"),
    ("09:00", "Casa Daza: S2"),
    ...
    ("10:00", "Metabeats"),
    ("11:00", "Beached: S3"),
    ("12:00", "My Italy with Margarita"),
    ("12:30", "EIC on the Move: S2"),
    ("13:00", "Casa Daza: S2"),
    ("13:30", "Asian Baking Adventures"),
    ("14:00", "Jamie's Quick and Easy Food"),
    ("15:00", "Metabeats"),
    ("16:00", "The Crawl"),
    ("16:30", "Potluck"),
    ("16:45", "Gourmet Takeaway"),
    ("17:00", "EIC on the Move: S2"),
    ("17:30", "It's a Small World"),
    ("18:00", "Pia's Postcards"),
    ("19:00", "Extraordinary Places to Eat"),
    ("20:00", "Casa Daza: S5"),
    ("20:30", "EIC on the Move: S2"),
    ("21:00", "Executive Class"),
    ("22:00", "My Italy with Margarita"),
    ("22:30", "Asian Baking Adventures"),
    ("23:00", "Let's Stan"),
)
METRO_FRIDAY = slots(
    ("00:00", "Kuwentong Barber"),
    ("01:00", "Jamie's Quick and Easy Food"),
    ("02:00", "Casa Daza: S2"),
    ("02:30", "EIC on the Move"),
    ("03:00", "Jamie and Jimmy's Food Fight Club"),
    ("04:00", "Executive Class"),
    ("05:00", "Tour vs. Tour: S3"),
    ("06:00", "Let's Stan"),
    ("07:00", "Metabeats"),
    ("07:30", "Asian Baking Adventures"),
    ("08:00", "Kapamilya Daily Mass"),
    ("08:30", "It's a Small World"),
    ("09:00", "Jamie and Jimmy's Food Fight Club"),
    ("10:00", "Jamie's Quick and Easy Food"),
    ("11:00", "Extraordinary Places to Eat"),
    ("12:00", "Potluck"),
    ("12:15", "Gourmet Takeaway"),
    ("12:30", "It's a Small World"),
    ("13:00", "My Italy with Margarita"),
    ("13:30", "EIC on the Move: S2"),
    ("14:00", "The Crawl"),
    ("14:30", "Asian Baking Adventures"),
    ("15:00", "Executive Class"),
    ("16:00", "Jamie and Jimmy's Food Fight Club"),
    ("17:00", "Let's Stan"),
    ("18:00", "Metabeats"),
    ("19:00", "Potluck"),
    ("19:15", "Gourmet Takeaway"),
    ("19:30", "My Italy with Margarita"),
    ("20:00", "Pia's Postcards"),
    ("21:00", "Kuwentong Barber"),
    ("22:00", "EIC on the Move: S2"),
    ("22:30", "It's a Small World"),
    ("23:00", "Jamie and Jimmy's Food Fight Club"),
)
METRO_SATURDAY = slots(
    ("00:00", "Tour vs. Tour: S3"),
    ("01:00", "Million Dollar Listing Miami"),
    ("02:00", "Let's Stan"),
    ("03:00", "My Italy with Margarita"),
    ("03:30", "The Crawl"),
    ("04:00", "Jamie's Quick and Easy Food"),
    ("05:00", "My Italy with Margarita"),
    ("05:30", "The Crawl"),
    ("06:00", "Jamie's Quick and Easy Food"),
    ("07:00", "We Rise Together"),
    ("08:00", "Kapamilya Daily Mass"),
    ("08:30", "Potluck"),
    ("08:45", "Gourmet Takeaway"),
    ("09:00", "Jamie's Quick and Easy Food"),
    ("10:00", "Metabeats"),
    ("11:00", "The Crawl"),
    ("11:30", "Asian Baking Adventures"),
    ("12:00", "Movies in the Metro"),
    ("14:00", "G Diaries: Share the Love"),
    ("15:30", "Pia's Postcards"),
    ("16:30", "Potluck"),
    ("16:45", "Gourmet Takeaway"),
    ("17:00", "Metabeats"),
    ("18:00", "Asian Baking Adventures"),
    ("18:30", "EIC on the Move: S2"),
    ("19:00", "Let's Stan"),
    ("20:00", "It's a Small World"),
    ("20:30", "My Italy with Margarita"),
    ("21:00", "Executive Class"),
    ("22:00", "Million Dollar Listing Miami"),
    ("23:00", "Tour vs. Tour: S3"),
)
METRO_SUNDAY = slots(
    ("00:00", "The Crawl"),
    ("00:30", "EIC on the Move: S2"),
    ("01:00", "Let's Stan"),
    ("02:00", "Kuwentong Barber"),
    ("03:00", "Pia's Postcards"),
    ("04:00", "Tour vs. Tour: S3"),
    ("05:00", "Call to Cosplay"),
    ("05:30", "The Crossover"),
    ("06:00", "Jamie's Quick and Easy Food"),
    ("07:00", "Let's Stan"),
    ("08:00", "Kapamilya Sunday Mass"),
    ("08:30", "Kapamilya Journeys of Hope"),
    ("09:00", "Pia's Postcards"),
    ("10:00", "Metabeats"),
    ("11:00", "Jamie and Jimmy's Food Fight Club"),
    ("12:00", "Potluck"),
    ("12:15", "Gourmet Takeaway"),
    ("12:30", "The Crawl"),
    ("13:00", "Executive Class"),
    ("14:00", "EIC on the Move: S2"),
    ("14:30", "Let's Stan"),
    ("15:30", "G Diaries Share the Love"),
    ("17:00", "Jamie's Quick and Easy Food"),
    ("18:00", "My Italy with Margarita"),
    ("18:30", "Pia's Postcards"),
    ("19:30", "EIC on the Move: S3"),
    ("20:00", "Casa Daza: S5"),
    ("20:30", "At The Table"),
    ("21:00", "ASAP Natin 'To"),
    ("23:00", "Foodprints"),
