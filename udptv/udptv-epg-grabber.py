...
USER_AGENT = "UDPTV-EPG-Grabber/3.1"
...
# Only these 13 channels are retained from the much larger private JioTV
# deployment. Source IDs are stable numeric IDs generated by the Jio scraper;
# the separate *.jio IDs deliberately coexist with other UDPTV providers.
JIO_EPG_URL = "https://jioepg.djdoolky76.com/epg.xml.gz"
JIO_SOURCE_ID_ALIASES = {
...
GMA_EPG_URL = "https://kaotv.ganbaruby23.xyz/gma_epg.php"
GMA_SOURCE_ID_ALIASES = {
    "tolka.98": "heartofasia.ph",
    "tolka.101": "iheartmovies.ph",
}
GMA_EPG_IDS = frozenset(GMA_SOURCE_ID_ALIASES.values())
...
SOURCES = (
    ...
    Source("KAO TV GMA", GMA_EPG_URL, GMA_EPG_IDS),
    Source("JioTV selected channels", JIO_EPG_URL, JIO_EPG_IDS),
    Source(
        "Mediaquest Cignal",
